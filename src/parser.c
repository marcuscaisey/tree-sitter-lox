...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_expression, 3, .production_id = 2),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_group_expression, 3, .production_id = 2),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, .production_id = 1),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 2, .production_id = 1),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__literal, 1),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__literal, 1),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ternary_expression, 5, .production_id = 4),
